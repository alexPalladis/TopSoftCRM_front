...
function TicketViewDialog({ ticket, open, onClose, onComplete, canAct }) {
  ...
  const fromColors = entityColors[ticket.fromType] || entityColors.DEALER;
  const toColors = entityColors[ticket.toType] || entityColors.DEALER;
...
function TicketFormDialog({ open, onClose, onSaved, ticket, currentUser }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const payload = {
        fromType: currentUser?.role || "DEALER",
                    ...
                    return (
                      ...
                      >
                        ...
                        >
                          ...
                          {/* Edit & Delete only for tickets the dealer created themselves */}
                          {isMine && (
                            <>
