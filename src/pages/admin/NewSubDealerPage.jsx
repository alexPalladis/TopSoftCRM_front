...
export default function NewSubDealerPage() {
    ...
    <Box>
      ...
      {submitted && (
        <Alert severity="success" sx={{ mb: 2 }}>
          Ο sub-dealer καταχωρήθηκε επιτυχώς!
        </Alert>
      )}
      {errors.general && (
